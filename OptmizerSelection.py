...
def findAccuracyOnTestSet(optName):
    ...
    print('Optimizer Name =',optName,' error rate on test set =', total_error*100)

#Initilaizing the Loss. Here I chose CrossEntropy loss as its a classification problem.    
criterion = nn.CrossEntropyLoss()

learningRate=0.001
for optimizer in range(1,7):
    ...
    #Initilaizing different optimizers with same learning rate.
    if(optimizer == 1):
    ...
    for epoch in range(1,151): 
        ...
        print('epoch=',epoch)
        print('Optimizer Name =',optName,' loss=', total_loss)
        print('Optimizer Name =',optName,' total error=',total_error*100)
        
        #Find the average error 
        findAccuracyOnTestSet(optName)
